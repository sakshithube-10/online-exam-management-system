...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="photo.jpg" alt="Yadnyesh & Sakshi" width="400" height="300">
        <p><strong>Yadnyesh & Sakshi </strong></p>
        <p>3rd YEAR BSC COMPUTER SCIENCE</p>
      </div>
    </div>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      <p>Contact us and we'll see through your request.</p>
      <p><span class="glyphicon glyphicon-map-marker"></span> MUMBAI,INDIA</p>
      <p><span class="glyphicon glyphicon-phone"></span> +91 7738847518 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> yadnyesh@gmail.com</p>
    </div>
